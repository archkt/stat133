...
```{r}
# your code
future_value = function(principal, annual_rate, years){
...
```{r}
# your code
paul_return = future_value(1000, 0.02, 5)
paul_return
```
...
```{r}
# your code
annuity(pmt=1200, r=0.06, years=10)
```
...
```{r}
# your code
annuity(pmt=1200, r=0.06, years=10, due=TRUE)
```
...
- `app2.R`: sample shiny app for graphing a timeline for Future Value (of 
compound interest) using a randomly generated rate of return.
